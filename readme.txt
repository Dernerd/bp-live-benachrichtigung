...
**Do you need more awesome BuddyPress Plugins?** Checkout [BuddyPress Plugins by WMS N@W](https://n3rds.work/)
== Installation ==
...
1. Upload `bp-live-benachrichtigung` directory to the `/wp-content/plugins/` directory
...
Please visit [WMS N@W](https://n3rds.work) for support.
...
== Other Notes ==
 Please leave a comment on our blog [WMS N@W](https://n3rds.work/)
